...
export default function Contact() {
  ...
  const socialLinks = [
    { name: "GitHub", url: siteConfig.socials.github, description: "Zie mijn codes", icon: <GitHub className="w-8 h-8" /> },
    { name: "Itch.io", url: siteConfig.socials.itch, description: "Speel mijn games", icon: <Itch className="w-8 h-8" /> },
    { name: "LinkedIn", url: siteConfig.socials.linkedin, description: "Link in met mij", icon: <LinkedIn className="w-8 h-8" /> },
  ];
